...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        After living my life emerged in classical music since the age of
        ActiveSectionContextProvider, I decided to pursue my passion for
        ...
        the never ending space to learn. I{" "}
